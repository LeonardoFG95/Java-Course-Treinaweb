...
public class MainBKP {
	...
	public static void main(String[] args) {
		...
		Empregado novoEmpregado = binaryOperator.apply(new Empregado(0, "Treina", 1000, ""), new Empregado(0, "Web", 10000, "Junção"));
		System.out.println(novoEmpregado.getNome() + ", R$" + novoEmpregado.getSalario());
		
		// Predicate
		System.out.println("Execução de Predicate: ");
