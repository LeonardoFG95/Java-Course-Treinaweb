...
public class Main {
	...
	public static void main(String[] args) {
		 ...
		 * System.out.println("Digite o número a ser pesquisado: "); int alvo =
		 ...
		 * System.out.println("Elemento não encontrado."); } else {
		 * System.out.println(String.format("O número %d foi encontrado na posição %d",
